  ...
  return (
    <div className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Grid pattern */}
        <div className="absolute inset-0 bg-grid-indigo-100 opacity-[0.15]" style={{ 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-lg">
              EduGami transforms education through AI-powered gamification and real-world career simulations, making learning both effective and enjoyable.
            </p>
            ...
            <div className="flex items-center text-gray-500 text-sm gap-4">
              <div className="flex -space-x-2">
                <div className="w-8 h-8 rounded-full bg-indigo-200 flex items-center justify-center text-xs text-indigo-800 font-medium border-2 border-white">A</div>
                <div className="w-8 h-8 rounded-full bg-blue-200 flex items-center justify-center text-xs text-blue-800 font-medium border-2 border-white">B</div>
                <div className="w-8 h-8 rounded-full bg-green-200 flex items-center justify-center text-xs text-green-800 font-medium border-2 border-white">C</div>
                <div className="w-8 h-8 rounded-full bg-purple-200 flex items-center justify-center text-xs text-purple-800 font-medium border-2 border-white">D</div>
              </div>
                ...
                <div className="p-5">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center bg-indigo-100 px-3 py-1 rounded-full">
                      ...
                      <span className="text-sm font-medium text-indigo-800">2,450 XP</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex justify-between items-center mb-2">
                        <h4 className="font-semibold text-indigo-900">Data Visualization Challenge</h4>
                        <span className="text-xs bg-purple-200 text-purple-800 px-2 py-1 rounded-full">+200 XP</span>
                      </div>
                      <p className="text-sm text-gray-600 mb-3">Create interactive dashboards with real-world datasets</p>
                    ...
                    >
                      <div className="flex justify-between items-center mb-2">
                        <h4 className="font-semibold text-blue-900">AI Ethics Simulation</h4>
                        <span className="text-xs bg-blue-200 text-blue-800 px-2 py-1 rounded-full">Career Skill</span>
                      </div>
                      <p className="text-sm text-gray-600 mb-3">Navigate ethical dilemmas in a virtual tech company</p>
                    ...
                    >
                      <div className="flex justify-between items-center mb-2">
                        <h4 className="font-semibold text-green-900">Token Marketplace</h4>
                        <span className="text-xs bg-green-200 text-green-800 px-2 py-1 rounded-full">Economy</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <div className="flex items-center">
                          <div className="w-8 h-8 bg-green-200 rounded-full flex items-center justify-center mr-2">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-green-800">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                          </div>
                          <span className="font-medium text-green-800">1,250 Tokens</span>
                        </div>
                        <button className="text-sm text-white bg-green-600 hover:bg-green-700 px-3 py-1 rounded">Shop Now</button>
                      </div>
                    </motion.div>
                  </div>
                </div>
