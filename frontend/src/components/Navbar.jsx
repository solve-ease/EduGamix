        ...
        <div className="flex justify-between items-center">
          ...
          >
            <div className="flex items-center">
              ...
              <span className="text-2xl font-bold text-indigo-900">EduGami</span>
            </div>
          </motion.div>
        ...
        {isOpen && (
          ...
          >
            <div className="px-4 py-2 space-y-1">
              ...
              <MobileNavLink href="#how-it-works" label="How It Works" onClick={() => setIsOpen(false)} />
              <MobileNavLink href="#testimonials" label="Testimonials" onClick={() => setIsOpen(false)} />
