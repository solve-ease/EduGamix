      ...
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-2xl font-semibold text-indigo-900">Phase {phase} Video Lesson</h3>
          </div>
          <div className="mb-4">
        ...
        {phase === 2 && (
          <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-semibold text-indigo-900">Virtual Interview Session</h3>
            </div>
            <p className="text-gray-600 mb-4">
              Experience a simulated interview with an AI-powered avatar. Answer questions and receive real-time feedback to improve your skills.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
        ...
        {interviewStarted && (
          ...
          >
            <h3 className="text-2xl font-semibold text-indigo-900 mb-4">Interview in Progress</h3>
            <p className="text-gray-600">
              Your AI tutor is now interviewing you. Please answer the questions as they appear. 
