...
import { ChevronDown, BookOpen, Trophy, Calendar, Users, Brain, Award, Code, DollarSign, BarChart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white">
      ...
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            EduGami combines gamification, AI personalization, and real-world simulations to create 
            an engaging learning environment that prepares students for their future careers.
          </motion.p>
        </div>
        ...
        >
          <a href="#learn-more" className="flex flex-col items-center text-indigo-600 hover:text-indigo-800 transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="p-6">
                  <div className="bg-indigo-50 rounded-lg p-4 mb-4">
                    <div className="flex items-center mb-3">
                      ...
                      <div className="ml-3">
                        <h4 className="font-semibold text-indigo-800">Python Challenge</h4>
                        <p className="text-xs text-indigo-600">Level 3 • 120 XP</p>
                      </div>
                    </div>
                  ...
                  <div className="bg-green-50 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <h4 className="font-semibold text-green-800">Achievement Unlocked!</h4>
                          <p className="text-xs text-green-600">Code Master • +200 Tokens</p>
                        </div>
                      </div>
                      <motion.div 
                        initial={{ scale: 0 }}
                  ...
                  <div className="bg-blue-50 rounded-lg p-4">
                    <div className="flex items-center mb-3">
                      ...
                      <div className="ml-3">
                        <h4 className="font-semibold text-blue-800">Interview Simulation</h4>
                        <p className="text-xs text-blue-600">Junior Developer • 30 minutes</p>
                      </div>
                    </div>
                    <motion.button 
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="text-2xl font-bold text-indigo-900 mb-6">A Complete Learning Ecosystem</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-indigo-800 mb-1">Reinforcement Learning</h4>
                    <p className="text-gray-600">Our AI adapts challenge levels in real-time based on your performance, keeping you in the optimal learning zone.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-indigo-800 mb-1">Token Economy</h4>
                    <p className="text-gray-600">Earn tokens by completing challenges and spend them in our virtual marketplace on courses, resources, and more.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-indigo-800 mb-1">Virtual Career Simulations</h4>
                    <p className="text-gray-600">Practice interviews and workplace scenarios with AI avatars that provide constructive feedback to improve your skills.</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 px-4 md:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.p 
            ...
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            Our platform has helped thousands of students improve their skills and find their dream jobs.
          </motion.p>
