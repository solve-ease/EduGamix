...
const coursesData = [
  {
    ...
    description: 'Learn Python basics with interactive coding challenges and real-world examples.',
    tags: ['Programming', 'Python', 'Beginner']
  },
  {
    id: 2,
    title: 'Web Development Bootcamp',
    description: 'Master HTML, CSS, and JavaScript to build responsive, modern websites.',
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {course.tags.map((tag, idx) => (
                  <span key={idx} className="inline-flex items-center bg-indigo-100 text-indigo-800 text-xs font-medium px-2.5 py-0.5 rounded">
