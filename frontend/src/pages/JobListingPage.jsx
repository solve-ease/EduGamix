...
const JobListingPage = () => {
  ...
  const calculateBidSuccessRate = (job) => {
    ...
    const experienceMatch = job.requiredExperience === 'Beginner' ? 0.8 : 
                           job.requiredExperience === 'Intermediate' ? 0.6 : 0.4;
    
    // Higher is better, scale from 0-100%
    return Math.min(100, Math.max(0, (90 - (competitionLevel * 5)) * experienceMatch));
  };
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      <div className="bg-white shadow overflow-hidden sm:rounded-md">
        <div className="px-4 py-5 border-b border-gray-200 sm:px-6">
          <h1 className="text-2xl font-bold text-gray-900">Available Quests</h1>
          <p className="mt-1 text-sm text-gray-500">Find your next adventure and earn XP</p>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div className="ml-2 flex-shrink-0 flex">
                            <p className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                              ${job.difficulty === 'Beginner' ? 'bg-green-100 text-green-800' : 
                        ...
                        <div className="flex items-center">
                          <div className="flex items-center text-sm text-gray-500">
                            ...
                            <p>${job.paymentRange[0]}-{job.paymentRange[1]}</p>
                          </div>
